...
and aided the head of the IT department with various tasks aroung the school. Sometimes I created my own opportunities when exploring these interests.
For example, during one school week, myself and a peer would stay behind for a few extra hours to understand a the code on a GitHub repository that allowed people to scan 3D objects with an Xbox Kinect. Of course, after learning a bit about the software, we proceeded to create and print a miniature bust of myself on our school&apos;s 3D printer.
...
Both of these are fond memories that have helped shape my interests and hobbies. I still have the 3D printed bust of myself on my shelf at home, and after graduating high school I purchased my own 3D printer which I used to print items that I find online or design myself for other projects.
...
When indoors I enjoy watching movies and playing single-player story-driven games. Recently I have also begun to delve into more tabletop games such as Dungeons and Dragons. I also enjoy cooking and doing various DIY projects. That&apos;s a little bit about myself. If you&apos;re interested in contacting me for any reason please feel free to contact me through any of the methods listed at the top of this page. I look forward to meeting you!
          </p>
        </div>
      </section>
